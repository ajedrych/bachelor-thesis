...
library(stargazer)
stargazer(model1, model6, model_glm, model6.lmw, autocorr, type="html", align= TRUE, style="default", df=TRUE, column.labels = c("MNK wersja pierwsza", "MNK wersja finalna", "SUMNK", "WMNK", "estymator Neweya-Westa"), out="C://Users//aleks//WNE//bachelor-thesis//Model OLS - traffic incidents//model.html")
